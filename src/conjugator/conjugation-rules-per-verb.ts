...
export const verb_conjugation_rules: {[infinitive: string]: ConjugationRules | null} = {
    ...
    jugar: {irregular: {base: "jugar"}, stem_change_type: "u:ue", stem_change_inclusions: ["PresInd"]},
    lanzar: null,
    lavar: null,
    ...
    quedar: null,
    querer: {irregular: {base: "querer"}, stem_change_type: "e:ie", stem_change_inclusions: ["PresInd"]},
    quitar: null,
    rascar: {model: "sacar"},
    realizar: null,
    rebautizar: null,
